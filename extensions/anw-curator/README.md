...
1. Download `anw-curator-v0.1.2.zip` from the [Releases page](https://github.com/welt-weit/anw-downloads/releases) and **unzip it**. (You can't pick the `.zip` directly in Chrome — it needs the unzipped folder.)
...
v0.1.2 — Phases 1–4 complete (scaffold, core flow, badge + history, zip
distribution), plus toolbar-icon submit feedback (… → ✓ / !) and a
latency-hardened popup. Remaining items are API-side: issuable/scoped/revocable
`anw_` tokens, and Bearer support on the token-test endpoint.
